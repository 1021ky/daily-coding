...
content = None
if argument.counts_characters:
    content = CharacterContent(file_content)
elif argument.counts_words:
    content = WordContent(file_content)
elif argument.counts_lines:
    content = LineContent(file_content)
else:
    content = ByteContent(file_content)
if content:
    print(len(content))
